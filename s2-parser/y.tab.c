...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_INTEGER_LITERAL = 261        /* T_INTEGER_LITERAL  */
  };
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_INTEGER_LITERAL = 6,          /* T_INTEGER_LITERAL  */
  YYSYMBOL_7_ = 7,                         /* '('  */
  YYSYMBOL_8_ = 8,                         /* ')'  */
  YYSYMBOL_9_ = 9,                         /* '{'  */
  YYSYMBOL_10_ = 10,                       /* '}'  */
...
#line 1130 "y.tab.c"
  ...
  case 3: /* $@1: %empty  */
#line 21 "parser.y"
                              { printf("define %s @%s() ", yyvsp[-3], yyvsp[-2]); }
#line 1136 "y.tab.c"
    break;
